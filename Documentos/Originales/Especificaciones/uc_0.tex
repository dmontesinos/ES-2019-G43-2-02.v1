...
\begin{itemize}
<<<<<<< HEAD
\item Si el usuario finaliza el nivel dentro del tiempo no ocurre nada.
\item En caso contrario, se redirige al usuario al menú principal.
\end{itemize}

=======
\item En el caso de que el tiempo llegue a 0 el usuario perderá la partida.
\item Se redirige al usuario al menú principal.
\end{itemize}



\section{Caso de uso : 0031 - USUARIO: Consultar bonus obtenidos}\label{sec:uc0}
\subsection{Flujo de eventos}
\subsubsection{Básico}

\begin{enumerate}
\item Paso 1.
El jugador debe presionar una tecla para acceder a los bonus obtenidos.
\item Paso 2.
Se le muestra al usuario los bonus obtenidos anteriormente.
\end{enumerate}

\subsection{Precondiciones}
\begin{itemize}
\item El usuario debe haber conseguido algún bonus durante la partida.
\end{itemize}

\subsection{Postcondiciones}
\begin{itemize}
\item Se redirige al usuario a la partida de nuevo.
\end{itemize}
>>>>>>> 689c7b8cd3f871c45d99b52c43edc5c8cf0c8f4d
