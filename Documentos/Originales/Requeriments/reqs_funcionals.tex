...
El sistema gestionará los niveles de mayor a menos dificultad.}{A}{R}{REQ-F-1-19}

\requeriment{REQ-F-1-22}{SISTEMA: Gestionar ranking}{
El sistema gestionará el ranking de mayor a menor puntuación.}{A}{R}{REQ-F-1-19}

\requeriment{REQ-F-1-23}{SISTEMA: Gestionar cuentas}{
El sistema gestionará todas las cuentas de usuario (nombre de usuario, contraseña, datos del usuario).}{A}{R}{REQ-F-1-19}

\requeriment{REQ-F-1-24}{SISTEMA: Gestionar mapas}{
El sistema gestionará todos los mapas del juego.}{A}{R}{REQ-F-1-19}

\requeriment{REQ-F-1-25}{ADMIN: Ver estados de los usuarios}{
El administrador podrá ver el estado de los usuarios online (jugando, esperando o desconectador).}{A}{R}
